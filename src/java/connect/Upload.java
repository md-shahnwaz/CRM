    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            if (db.insertUpdateDelete(query) == true){
                ...
                out.print("<script>alert('Product is added');window.location.href='adminzone/products.jsp';</script>");
            } else{
                out.print("<script>alert('Product is not added');window.location.href='adminzone/products.jsp';</script>");
            }
        }
